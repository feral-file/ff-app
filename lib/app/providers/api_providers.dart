...
import '../../infra/config/app_config.dart';
import '../../infra/database/database_provider.dart';
import 'api_retry_strategy.dart';
...
/// );
/// ```
final fetchChannelProvider = FutureProvider.autoDispose.family<
    Channel,
    String
>(
  (ref, channelId) async {
...
/// 
/// Uses automatic retry with custom strategy.
final fetchTokensByCIDsProvider = FutureProvider.autoDispose.family<
...
final fetchTokensByAddressesProvider = FutureProvider.autoDispose.family<
    int,
    List<String>
>(
  (ref, addresses) async {
