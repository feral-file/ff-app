...
void main() {
  ...
  test(
    'IndexerService.fetchTokensByCIDs batches in chunks of 40 when list is large',
    () async {
      final client = FakeIndexerClient()
      ...
      expect(List<String>.from(client.tokenQueryVars[0]['token_cids'] as List),
          hasLength(40));
      expect(client.tokenQueryVars[0]['limit'], equals(40));
      expect(client.tokenQueryVars[0]['offset'], equals(0));

      expect(List<String>.from(client.tokenQueryVars[1]['token_cids'] as List),
          hasLength(40));
      expect(client.tokenQueryVars[1]['limit'], equals(40));
      expect(client.tokenQueryVars[1]['offset'], equals(0));

      expect(List<String>.from(client.tokenQueryVars[2]['token_cids'] as List),
          hasLength(5));
  ...
  test(
    ...
    () async {
      ...
      expect(List<int>.from(client.tokenQueryVars[0]['token_ids'] as List),
          hasLength(255));
      expect(client.tokenQueryVars[0]['limit'], equals(255));
      expect(client.tokenQueryVars[0]['offset'], equals(0));

      expect(List<int>.from(client.tokenQueryVars[1]['token_ids'] as List),
          hasLength(45));
